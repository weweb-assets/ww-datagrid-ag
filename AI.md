...
- rowDragStart: Triggered when dragging column is initiated. Payload: { row: { /* row data */}, id: 0 }
- rowDragged: Triggered when dragging column ended. Payload: { row: { /* row data */}, id: 0, targetIndex: 0, rows: Array[RowData] }
